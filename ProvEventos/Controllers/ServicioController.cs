...
namespace ProvEventos.Controllers
{
    public class ServicioController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Nombre,Descripcion,Imagen")] Servicio servicio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Nombre,Descripcion,Imagen")] Servicio servicio)
        {
            if (ModelState.IsValid)
            {
